...
const Header = () => {
  ...
  // Fungsi untuk mengambil genre dari TMDB API
  const fetchGenres = async (mediaType) => {
    ...
    try {
      ...
      console.error(`Error al buscar géneros para ${mediaType}:`, err);
  ...
  // Efek untuk memuat genre saat komponen dimuat
  useEffect(() => {
  ...
  return (
    <>
      <style>
        ...
        /* Perbaikan untuk tombol Inicio agar hover tidak memanjang */
        .nav-button-content {
          display: flex;
          align-items: center;
          justify-content: center;
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between flex-wrap">
          ...
          <div className="flex items-center">
            <a href="/about" className="flex items-center text-4xl font-extrabold tracking-tight cursor-pointer">
              ...
              <span className="rainbow-text-header">Estreno Ya</span>
            </a>
          </div>
          ...
          <nav className="flex items-center space-x-6 mt-4 sm:mt-0">
            ...
            {/* Tombol Genre Film dengan fungsionalitas pop-up */}
            <div>
              <button
            ...
            {/* Tombol Genre Acara TV dengan fungsionalitas pop-up */}
            <div>
              <button
          ...
          <form onSubmit={handleSearchSubmit} className="relative">
            <input
              ...
              placeholder="Buscar películas o series de TV..."
      ...
      {isMoviesGenreOpen && (
        <div className="genre-popup-backdrop" onClick={() => setIsMoviesGenreOpen(false)}>
          <div className="genre-popup" onClick={(e) => e.stopPropagation()}>
            ...
            <h2 className="text-xl font-bold text-white mb-4">Géneros de Películas</h2>
            {loadingGenres ? (
              <p className="text-gray-400">Cargando géneros...</p>
            ) : error ? (
              <p className="text-red-400">Error al cargar géneros: {error}</p>
            ) : (
      ...
      {isTvShowsGenreOpen && (
        <div className="genre-popup-backdrop" onClick={() => setIsTvShowsGenreOpen(false)}>
          <div className="genre-popup" onClick={(e) => e.stopPropagation()}>
            ...
            <h2 className="text-xl font-bold text-white mb-4">Géneros de Series de TV</h2>
            {loadingGenres ? (
              <p className="text-gray-400">Cargando géneros...</p>
            ) : error ? (
              <p className="text-red-400">Error al cargar géneros: {error}</p>
